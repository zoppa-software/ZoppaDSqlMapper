...
Namespace Tokens
    ...
    Public NotInheritable Class PeriodToken
        Implements IToken

        ''' <summary>遅延インスタンス生成プロパティ。</summary>
        Private Shared ReadOnly Property LazyInstance() As New Lazy(Of PeriodToken)(Function() New PeriodToken())

        ''' <summary>唯一のインスタンスを返します。</summary>
        Public Shared ReadOnly Property Value() As PeriodToken
            Get
